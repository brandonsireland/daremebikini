...
var headerSwiper = new Swiper('.swiper-container', {
  ...
  //Insta Shop Carousel
  var carouselSwiper = new Swiper('.swiper-two', {
    slidesPerView: 4,
    loop: true,
    autoplay: {
        delay:2000,
...
// Waypoints
// var firstPoint = new Waypoint({
//     element: document.getElementById('jarallax'),
//     handler: function(direction) {
//       document.getElementById('firstPhoto').classList.add('animate' , 'fadeIn');
//     },
//     offset: 20,
//   });

//   var secondPoint = new Waypoint({
//     element: document.getElementById('jarallax'),
//     handler: function(direction) {
//         document.getElementById('secondPhoto').classList.add('animated' ,'fadeIn');
//     },
//     offset: '40%'
//   });

//   var thirdPoint = new Waypoint({
//     element: document.getElementById('jarallax'),
//     handler: function(direction) {
//         document.getElementById('thirdPhoto').classList.add('animated' ,'fadeIn');
//     },
//     offset: '60%'
//   });
